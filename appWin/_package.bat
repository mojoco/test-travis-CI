...
:: -tsa http://sha256timestamp.ws.symantec.com/sha256/timestamp
	call %SDK_HOME%\bin\adt.bat -package -storetype "pkcs12" -keystore "certificate.p12" -tsa http://sha256timestamp.ws.symantec.com/sha256/timestamp -storepass "1234" -target bundle "Main.exe" "Main-app.xml" "Main.swf"
